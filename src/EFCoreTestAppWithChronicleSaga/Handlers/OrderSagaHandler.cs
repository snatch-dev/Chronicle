...
namespace EFCoreTestApp.Handlers
{
    public class OrderSagaHandler: IRequestHandler<CreateOrder>, INotificationHandler<OrderCreated>
    {
        ...
        */
        ...
        private ICustomUnitOfWork<SagaDbContext> SagaUnitOfWork { get; }

        public OrderSagaHandler(ISagaCoordinator coordinator, ICustomUnitOfWork<SagaDbContext> _sagaUnitOfWork)
        {
